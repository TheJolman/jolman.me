      ...
      <div class="w-full px-6">
        <div class="bg-gray-50 rounded-lg p-6 mb-6 border border-gray-200 shadow-sm">
          ...
          <p class="text-gray-700 mb-4">
            ...
            Fullerton where I am now, in my final semester. My degree will be in
            CS with a minor in Math. I am a board member of my schools ACM
            chapter where I co-lead one of our open-source projects.
          </p>
          <p class="text-gray-700 mb-4">
          ...
          <p class="text-gray-700 mb-4">
            ...
            competetively up until recently, and I also enjoy golf and
            snowboarding (although my wallet doesn't).
          </p>
